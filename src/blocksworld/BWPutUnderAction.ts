...
class BWPutUnder_IntentionAction extends IntentionAction {
	...
	{
		if (intention.functor.is_a(ai.o.getSort("action.put-under"))) return true;
		return false;
	}
	...
	{
		let str = "<IntentionAction type=\"BWPutUnder_IntentionAction\"";
		return str + "/>";
	}
	...
	{
		let a:BWPutUnder_IntentionAction = new BWPutUnder_IntentionAction();
		return a;
	}
}
