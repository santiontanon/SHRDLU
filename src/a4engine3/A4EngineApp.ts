...
var SHRDLU_VERSION:string = "v3.6"
        ...
        if (this.state_cycle==0) {
            ...
            menuCallbacks.push(
                function(arg:any, ID:number) {
                       ...
                       BInterface.addElement(new BShrdluButton("male character", fontFamily32px, app.screen_width/2-80, 72*PIXEL_SIZE, 160, 8*PIXEL_SIZE, 42, 
                                                         "white", true,
                                                         function(arg:any, ID:number) {
                                                            app.titlescreen_state = 2;
                                                            app.titlescreen_timer = 0;
                       ...
                       BInterface.addElement(new BShrdluButton("Back", fontFamily32px, app.screen_width/2-80, 88*PIXEL_SIZE, 160, 64, 43, 
                                                         "white", true,
                                                         function(arg:any, ID:number) {
                                                            BInterface.pop();
                                                         }));
...
//                            console.log(xml);
    ...
    achievement_progress_string(idx:number) : string[]
    {
        ...
        switch(this.achievement_names[idx]) {
            ...
            case "Etaoin at your service":
                {
                    let first:boolean[] = [true, true, true, true, true, true, true];
                    let tags:string[] =   ["connect to", "open", "close", "switch on", "switch off", "3d print", "reboot"];
                    lines = ["Done: ", "Missing: "];
            ...
            case "Robots at your service":
                {
                    let first:boolean[] = [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true];
                    let tags:string[] =   ["follow", "move", "guide", "stop", "put in", "drop", "give", "open", "close", "turn", "push", "repair", "take", "stay", "reboot"];
                    lines = ["Done: ", "Missing: "];
    ...
    loadAchievements()
    {
        ...
        if (ach_xml!=null) {
            ...
            if (slot_xml != null) this.achievement_both_genders = <boolean []>eval(slot_xml.getAttribute("value"));
    ...
    titlescreen_requested_gender:string = null;
    ...
    achievement_both_genders:boolean[] = [false,false];
    ...
    achievement_nlp_all_etaoin_actions:boolean[] = [false,false,false,false,false,false];
    achievement_nlp_all_robot_actions:boolean[] = [false,false,false,false,false,false,false,false,false,false,false,false,false,false,false];
