...
this.addTokenPOS(new PartOfSpeech("allowed to enter", "permitted-in", Term.fromString("preposition('permitted-in'[permitted-in])", o), 1.0));
  ...
  */  
  ...
  this.addTokenPOS(new PartOfSpeech("in", "space.at", Term.fromString("preposition('space.at'[space.at])", o), 1.0));
    ...
    this.addStandardNounPOS("chemical element", "chemical-element", o);
    ...
    this.addStandardNounPOS("memory", "memory-bank", o);
    ...
    this.addStandardNounPOS("movie", "movie", o);
    ...
    this.addStandardNounPOS("song", "song", o);
    ...
    this.addStandardNounPOS("video", "video", o);
    ...
    this.addStandardNounPOS("wheel", "wheel", o);
